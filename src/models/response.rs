...
pub struct Response {
  ...
  created_at: f32,
  #[serde(rename = "error")]
  error: crate::models::ResponseError,
  /// Unique identifier for this Response.
  #[serde(rename = "id")]
  id: String,
  #[serde(rename = "incomplete_details")]
  incomplete_details: crate::models::ResponseIncompleteDetails,
  ...
  #[serde(rename = "output")]
  output: Vec<crate::models::OutputItem>,
  ...
  #[serde(rename = "usage")]
  usage: Option<crate::models::ResponseUsage>
}
