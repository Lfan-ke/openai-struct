...
pub struct RealtimeResponse {
  ...
  #[serde(rename = "output")]
  output: Option<Vec<crate::models::RealtimeConversationItem>>,
  ...
  status_details: Option<crate::models::RealtimeResponseStatusDetails>,
  /// Sampling temperature for the model, limited to [0.6, 1.2]. Defaults to 0.8.
  #[serde(rename = "temperature")]
  temperature: Option<f32>,
  #[serde(rename = "usage")]
  usage: Option<crate::models::RealtimeResponseUsage>,
