...
pub struct CreateFineTuningJobRequest {
  ...
  hyperparameters: Option<crate::models::CreateFineTuningJobRequestHyperparameters>,
  /// A list of integrations to enable for your fine-tuning job.
  #[serde(rename = "integrations")]
  integrations: Option<Vec<crate::models::CreateFineTuningJobRequestIntegrations>>,
