...
pub struct ModifyAssistantRequestToolResources {
  ...
  code_interpreter: Option<crate::models::ModifyAssistantRequestToolResourcesCodeInterpreter>,
  #[serde(rename = "file_search")]
  file_search: Option<crate::models::ModifyAssistantRequestToolResourcesFileSearch>
}
