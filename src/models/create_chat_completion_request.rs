...
pub struct CreateChatCompletionRequest {
  ...
  user: Option<String>,
  #[serde(rename = "audio")]
  audio: Option<crate::models::CreateChatCompletionRequestAudio>,
  ...
  functions: Option<Vec<crate::models::ChatCompletionFunctions>>,
  ...
  messages: Vec<crate::models::ChatCompletionRequestMessage>,
  #[serde(rename = "modalities")]
  modalities: Option<crate::models::ResponseModalities>,
  ...
  #[serde(rename = "model")]
  model: crate::models::ModelIdsShared,
  ...
  seed: Option<i32>,
  #[serde(rename = "stop")]
  stop: Option<crate::models::StopConfiguration>,
  ...
  stream_options: Option<crate::models::ChatCompletionStreamOptions>,
  #[serde(rename = "tool_choice")]
  tool_choice: Option<crate::models::ChatCompletionToolChoiceOption>,
  ...
  web_search_options: Option<crate::models::WebSearch>
}
